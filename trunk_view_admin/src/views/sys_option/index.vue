<template>
    <div class="layout-container">
        ...
        <div class="layout-container-table">
            ...
            >
                <el-table-column prop="fromip" label="fromip" align="center" width="60" />
                <el-table-column prop="msgtext01" label="msgtext01" align="center" width="160"/>
                <el-table-column prop="desc" label="desc" align="center">
                </el-table-column>
                <el-table-column  label="来源" align="center" fixed="right" width="250">

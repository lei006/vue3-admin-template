...
type OptionRecordControl struct {
	BaseController
}

var OptionRecordControler = new(OptionRecordControl)

func (control *OptionRecordControl) Create(ctx *gin.Context) {
...
func (control *OptionRecordControl) DeleteOne(ctx *gin.Context) {
...
func (control *OptionRecordControl) DeleteMany(ctx *gin.Context) {
	var ids []string
...
func (control *OptionRecordControl) GetOne(ctx *gin.Context) {
	id := ctx.Param("id")
...
func (control *OptionRecordControl) GetList(ctx *gin.Context) {

	control.RetOK(ctx)
}

func (control *OptionRecordControl) GetPage(ctx *gin.Context) {

...
func (control *SysRecordControl) DeleteOne(ctx *gin.Context) {
...
func (control *SysRecordControl) GetOne(ctx *gin.Context) {
	id := ctx.Param("id")
...
func (control *SysRecordControl) GetList(ctx *gin.Context) {
